# Generated by Django 5.2 on 2025-04-15 19:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('confirmed', 'Confirmed'), ('past', 'Past')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='offers', to='users.order')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
